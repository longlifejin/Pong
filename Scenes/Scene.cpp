...
Scene::Scene(SceneIds id) : id(id), textureManager(ResourceMgr<sf::Texture>::Instance()), fontManager(ResourceMgr<sf::Font>::Instance()),
soundManager(ResourceMgr<sf::SoundBuffer>::Instance())
{
}
